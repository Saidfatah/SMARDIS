...
export const SecorPage = ({navigation,route,fetchSectorClients,selected_sector_Clients,visited_Sector_has_clients}) => {
    const [isExpanded, setisExpanded] = useState(false)

    const {sector} = route.params;
    const {city,name}=sector
    
    useEffect(() => {
        fetchSectorClients(sector.id)
